...
#nullable disable
#pragma warning disable CA1861 // Generated migration uses inline index column arrays.

namespace PatikaBeosztas.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class InitialOrganizationAuth : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfessionalRole = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    CountsAsPharmacist = table.Column<bool>(type: "boolean", nullable: false),
                    MonthlyMinutesLimit = table.Column<int>(type: "integer", nullable: true),
                    MaxDailyMinutes = table.Column<int>(type: "integer", nullable: true),
                    BirthDate = table.Column<DateOnly>(type: "date", nullable: true),
                    ExternalPayrollId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeAllowedTimeTypes", x => new { x.EmployeeId, x.TimeType });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeTimeWindows", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeLocations", x => new { x.EmployeeId, x.LocationId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAllowedTimeTypes_OrganizationId_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeLocations_OrganizationId_LocationId",
                table: "EmployeeLocations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_OrganizationId_ExternalPayrollId",
                table: "Employees",
                columns: new[] { "OrganizationId", "ExternalPayrollId" });

            migrationBuilder.CreateIndex(
                name: "IX_Employees_OrganizationId_IsActive",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTimeWindows_OrganizationId_EmployeeId",
                table: "EmployeeTimeWindows",
                columns: new[] { "OrganizationId", "EmployeeId" });

            migrationBuilder.CreateIndex(
                name: "IX_Locations_OrganizationId_IsActive",
                table: "Locations",
                columns: new[] { "OrganizationId", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPermissions_OrganizationId_Permission",
                table: "UserPermissions",
                columns: new[] { "OrganizationId", "Permission" });
