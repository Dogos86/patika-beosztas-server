...
kanonikus Phase 3A exportot mindig a runtime válaszból frissítsd; a JSON-t ne
szerkeszd kézzel:
...
A Phase 3A tartós beosztásgenerálás, CP-SAT optimalizálás és közzététel:
`docs/PHASE_3A_IMPLEMENTATION.md`.
